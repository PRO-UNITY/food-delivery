      ...
      >
        ...
        <div className="side-body ">
          <ul style={{listStyle:"none"}} className="px-3">
              ...
              <li className="nav-item">
                <NavLink to={localStorage.getItem('token')?"/order-history":"/login"} className="nav-link text-start px-2" isActive={() => checkActive("/order-history")}>
                    <p className="text-start py-3"><i className="fa-solid fa-clock-rotate-left mx-3"></i> Order History</p>
                </NavLink>
              </li>  
              <li className="nav-item">
                <NavLink to={localStorage.getItem('token')?"/settings":"/login"} className="nav-link text-start px-2" isActive={() => checkActive("/settings")}>
