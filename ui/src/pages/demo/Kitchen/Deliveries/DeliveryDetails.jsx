        ...
        <DemoLayout setSearch={setSearch}>
                ...
                <h3 className="mb-3">Settings</h3>
            {
                ...
                <div className="container-avatar">
                    <img  className="avatar-user" src={data?.avatar?data?.avatar:Supplier} alt="" />
                </div>
                <div className="w-100 mt-5">
                    <ul className="list-group w-100 mb-3">
                        <li className="list-group-item">Username : {data?.username}</li>
                        <li className="list-group-item">Firstname : {data?.first_name}</li>
                        <li className="list-group-item">Lastname : {data?.last_name}</li>
                        <li className="list-group-item">Email : {data?.email}</li>
                        <li className="list-group-item">Phone number : {data?.phone? data.phone : "No number yet"}</li>
                    </ul>
                </div>
               </div>
            }
