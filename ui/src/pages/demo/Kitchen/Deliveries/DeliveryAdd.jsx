...
import { AddWithFormData, getDataWithToken, getUserData } from "../../../../functions/function"; 
...
const DeliveryAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        AddWithFormData("/deliveryman/", formData).
    ...
    return (
        <DemoLayout setSearch={setSearch}>
            ...
            <div className="card w-100">
                <div style={{background:"#F8B602"}} className="card-header  text-light"><h3>Add Supplier</h3></div>
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <input ref={emailRef} type="email" placeholder="email" className="form-control mb-2" />
                        <input ref={phoneRef} type="text" placeholder="phone" className="form-control mb-2" />
                        <input ref={latitudeRef} type="text" placeholder="latitude" className="form-control mb-2" />
                        <input ref={longitudeRef} type="text" placeholder="longitude" className="form-control mb-2" />
                        <input ref={passwordRef} type="text" placeholder="password" className="form-control mb-2" />
                        <input ref={passwordRef2} type="text" placeholder="confirm password" className="form-control mb-2" />
                        <button type="submit" className="btn-orange">create</button>
                    </form>
                </div>
            </div>
            </div>
