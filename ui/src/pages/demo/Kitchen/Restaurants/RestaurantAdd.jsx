    ...
    return (
        <DemoLayout setSearch={setSearch}>
            ...
            <div className="card w-100">
                <div style={{background:"#F8B602"}} className="card-header  text-light"><h3>Add Restaurant</h3></div>
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <input ref={openref} type="text" placeholder="open_time" className="form-control mb-2" />
                        <input ref={closeref} type="text" placeholder="close_time" className="form-control mb-2" />
