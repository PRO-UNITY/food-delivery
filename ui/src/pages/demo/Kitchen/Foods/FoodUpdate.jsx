...
import { AddWithFormData, EditWithFormData, getUserData } from "../../../../functions/function"; 
...
const FoodUpdate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        EditWithFormData(`/foods/${id}`, formData).
        then(()=>navigate('/foods'))
    };
    ...
    return (
        <DemoLayout setSearch={setSearch}>
            ...
            <div className="card w-100">
                <div style={{background:"#F8B602"}} className="card-header  text-light"><h3>Add Food</h3></div>
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <select onChange={(e)=>setSelectkitchen(e.target.value)} value={selectkitchen} ref={kitchenref} name="" id="" className="form-control mb-2">
