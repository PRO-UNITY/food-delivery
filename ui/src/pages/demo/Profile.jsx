            ...
            <div className="d-flex justify-content-end align-items-center mb-4">
                {
                    ...
                    <img style={{width:"50px", height:"50px", objectFit:"cover", borderRadius:"50%"}} src={`${user?.avatar ? user?.avatar : User}`} alt="" />
                    </Link>
                    ...
                    card?.map((item, index)=>
                        <div key={index}>
                            <div className="card-order d-flex align-items-center justify-content-between mb-3">
                                ...
                                <img style={{width:"50px", height:"50px"}} src={`${item?.food_img}`} alt="" />
