...
const Register = () => {
    ...
    useEffect(()=>{
        if(username != "" && firstname != "" && lastname != "" && email != "" && password != "" && password2 != "" && role != "" ){
            setActive(true)
            console.log(active);
        }
    },[password2])
                ...
                <div className="card-body">
                    <form onSubmit={handleSignUpRestaurant}>
                        <div className="w-100 d-flex justify-content-between gap-2 mb-3">
                            ...
                            <input onChange={(e)=>setFirstname(e.target.value)} required placeholder="Andrey" className="w-100 form-control" type="text" />
                            </div>
                            <div className="w-50">
                            <label htmlFor="">Lastname</label>
                            <input onChange={(e)=>setLastname(e.target.value)} required placeholder="Molodsov" className="w-100 form-control" type="text" />
                            </div>
                        </div>
                        <div className="w-100 d-flex justify-content-between gap-2 mb-3">
                            <div className="w-50">
                            <label htmlFor="">Email</label>
                            <input onChange={(e)=>setEmail(e.target.value)} required placeholder="example@gmail.com" className="w-100 form-control" type="email" />
                            </div>
                            <div className="w-50">
                            <label htmlFor="">Username</label>
                            <input onChange={(e)=>setUsername(e.target.value)} required placeholder="Andrey1" className="w-100 form-control" type="text" />
                            </div>
                        </div>
                        <div className="w-100 d-flex justify-content-between gap-2 ">
                            <div className="w-50">
                            <label htmlFor="">Password</label>
                            <input onChange={(e)=>setPassword(e.target.value)} required placeholder="********" className="w-100 form-control" type="text" />
                            </div>
                            <div className="w-50">
                            <label htmlFor="">Confirm_password</label>
                            <input onChange={(e)=>setPassword2(e.target.value)} required placeholder="********" className="w-100 form-control" type="text" />
                            </div>
                        </div>
                        <div className="w-100 d-flex justify-content-between gap-2 ">
                            <div className="w-100">
